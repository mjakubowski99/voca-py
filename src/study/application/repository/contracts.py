...
from src.study.domain.value_objects import ExerciseId, LearningSessionId
...
class ISessionRepository(ABC):
    ...
    @abstractmethod
    async def save(self, session: LearningSession) -> LearningSession:
        pass

    @abstractmethod
    async def mark_all_user_sessions_finished(self, user_id: UserId) -> LearningSession:
        pass
